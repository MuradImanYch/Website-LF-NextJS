    ...
    return (
        <header>
            <div className="wrap">
                ...
                <div className='sign-in'><Link href="/login"><Image placeholder={'empty'} height={30} src={signIn} alt="Вход" title="Войти" /> <span>Войти</span></Link></div>
                <div className="settings">
                    <Link href={'/settings'}><Image placeholder={'empty'} src={settings} height={30} alt='Настройки' title='Настройки' /></Link>
                </div>
                ...
                <Link href={'/'}><Image placeholder={'empty'} className='logo' src={logo} width={40} alt="legfootball.com" title="Главная" /></Link>
                <Burger />
            </div>
            <Nav2 />
        </header>
