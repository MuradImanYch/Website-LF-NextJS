...
export const metadata = {
    title: 'Все футбольные турниры – Полный список и расписание',
    description: 'Ознакомьтесь с полным списком футбольных турниров, их расписанием и результатами. Найдите информацию о турнирах со всего мира.',
    keywords: 'футбольные турниры, расписание турниров, мировые турниры',
    openGraph: {
      type: 'website',
      title: 'Все футбольные турниры – Полный список и расписание',
      description: 'Ознакомьтесь с полным списком футбольных турниров, их расписанием и результатами. Найдите информацию о турнирах со всего мира.'
