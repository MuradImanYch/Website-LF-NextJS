...
export const generateMetadata = ({ params }) => {
    ...
    return {
        title: `Новости ${league[0]?.name.ru} ${country[0]?.name.ru} - последние события и обзоры - Страница ${params.page}`,
        description: `Читайте свежие новости и события ${league[0]?.name.ru} ${country[0]?.name.ru}. Обзоры матчей, интервью и аналитика. Страница ${params.page}`,
        keywords: `новости ${league[0]?.name.ru} ${country[0]?.name.ru}, события ${league[0]?.name.ru}, футбольные обзоры ${country[0]?.name.ru}, аналитика матчей ${country[0]?.name.ru}, Страница ${params.page}`,
        openGraph: {
          type: 'website',
          title: `Новости ${league[0]?.name.ru} ${country[0]?.name.ru} - последние события и обзоры - Страница ${params.page}`,
          description: `Читайте свежие новости и события ${league[0]?.name.ru} ${country[0]?.name.ru}. Обзоры матчей, интервью и аналитика. Страница ${params.page}`
