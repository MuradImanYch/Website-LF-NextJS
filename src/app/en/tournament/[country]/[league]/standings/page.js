import '@/app/tournament/[country]/[league]/standings/style.css';
...
export const generateMetadata = ({ params }) => {
    ...
    return {
        title: `${country[0]?.name.en} ${league[0]?.name.en} Standings - Current Team Positions`,
        description: `Updated ${country[0]?.name.en} ${league[0]?.name.en} standings. Check current team positions, statistics, and results.`,
        keywords: `${league[0]?.name.en} standings, team positions ${country[0]?.name.en}, current ${league[0]?.name.en} results`,
        openGraph: {
          type: 'website',
          title: `${country[0]?.name.en} ${league[0]?.name.en} Standings - Current Team Positions`,
          description: `Updated ${country[0]?.name.en} ${league[0]?.name.en} standings. Check current team positions, statistics, and results.`
