import '@/app/tournament/[country]/[league]/fixtures/style.css';
...
export const generateMetadata = ({ params }) => {
    ...
    return {
        title: `${country[0]?.name.en} ${league[0]?.name.en} Match Schedule - Upcoming Fixtures`,
        ...
        keywords: `${league[0]?.name.en} schedule, upcoming fixtures ${country[0]?.name.en}, match calendar`,
        openGraph: {
          type: 'website',
          title: `${country[0]?.name.en} ${league[0]?.name.en} Match Schedule - Upcoming Fixtures`,
          description: `Current schedule of upcoming ${country[0]?.name.en} ${league[0]?.name.en} matches. Find out when the key games will take place.`
